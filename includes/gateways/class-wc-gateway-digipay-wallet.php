<?php
if (!class_exists('WC_Gateway_Digipay_Wallet')) {
    class WC_Gateway_Digipay_Wallet extends WC_Gateway_Digipay_BPG
    {
        public function __construct()
        {
            ...
            $this->method_title = __('Digipay Wallet', 'digipay-multi-gateways');
            $this->method_description = __('پرداخت با کیف پول دیجی پی', 'digipay-multi-gateways');
            $this->icon = DIGIPAY_MG_URL . 'assets/images/3.svg';
        ...
        public function init_form_fields()
        {
            ...
            $this->form_fields['title']['default'] = __('کیف پول', 'digipay-multi-gateways');
        }
        ...
        public function process_payment($order_id)
        {
            ...
            $resp = $api->init_payment($order, 'wallet');
